...
- [ ] **FE-AUTH-01**: Register screen allowing new users to sign up with validation feedback.
- [ ] **FE-AUTH-02**: Login screen allowing users to authenticate, storing the returned JWT token to `localStorage`, and updating global login states.
- [ ] **FE-AUTH-03**: Secure route guard wrapping the dashboard and chat views, redirecting to `/login` if no valid token exists.
...
|-------------|-------|--------|
| FE-CORE-01 | Phase 23 | Pending |
| FE-CORE-02 | Phase 23 | Pending |
| FE-AUTH-01 | Phase 24 | Pending |
| FE-AUTH-02 | Phase 24 | Pending |
| FE-AUTH-03 | Phase 24 | Pending |
| FE-DOC-01 | Phase 25 | Pending |
| FE-DOC-02 | Phase 25 | Pending |
| FE-DOC-03 | Phase 25 | Pending |
| FE-DOC-04 | Phase 25 | Pending |
| FE-CHAT-01 | Phase 26 | Pending |
| FE-CHAT-02 | Phase 26 | Pending |
| FE-CHAT-03 | Phase 26 | Pending |
| FE-CHAT-04 | Phase 26 | Pending |
| FE-CHAT-05 | Phase 26 | Pending |
| FE-CHAT-06 | Phase 26 | Pending |
